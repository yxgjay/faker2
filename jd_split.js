...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://127.0.0.1/Aaron-lv/updateTeam/master/shareCodes/split.json')
  if (!res) {
    $.http.get({url: 'https://127.0.0.1/gh/Aaron-lv/updateTeam@master/shareCodes/split.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('https://127.0.0.1/gh/Aaron-lv/updateTeam@master/shareCodes/split.json')
  }
  let res2 = await getAuthorShareCode('https://127.0.0.1/shufflewzc/updateTeam/main/shareCodes/split.json')
  if (!res2) {
    res2 = await getAuthorShareCode('https://127.0.0.1/shufflewzc/updateTeam/main/shareCodes/split.json')
  }
